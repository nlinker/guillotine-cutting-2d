...
const PROBLEM: &str = "2600x1800:3:400x400x6,495x495x6,270x320x10,150x450x17r";
...
fn cfg(
    pop_size: usize, n_generations: usize, n_elite: usize, tournament_k: usize,
    p_crossover: f64, p_swap: f64, p_flip: f64, p_point: f64,
) -> GaConfig {
    GaConfig { pop_size, n_generations, n_elite, tournament_k,
               p_crossover, p_swap, p_flip, p_point }
}
