...
- Three-level lexicographic **Objective** `(sheets_used, staircase_area, bbox_grouping_penalty)` —
  minimizes sheet count first, then compacts the last sheet, then groups same-size pieces together
  for cleaner cut patterns (see [Objective function](#objective-function) below).
...
|------------------------------------------------------|------------------------------------------------------|
| <img src="docs/img/staircase_large.png" width="380"> | <img src="docs/img/staircase_small.png" width="380"> |
...
|--------------------|---------------------|
| <img src="docs/img/grouping_good.png" width="380"> | <img src="docs/img/grouping_bad.png" width="380"> |
