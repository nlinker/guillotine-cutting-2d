...
mod tests {
    ...
    fn decode_two_sheets() {
        ...
        let problem = parse_problem("200x150:5:120x80,60x80,200x60,70x100r,60x70r").expect("Error parsing problem");
        let genome = vec![
            g(0, false, 0),
            g(1, false, 0),
            g(2, false, 0),
    ...
    fn objective_prefers_smaller_area_on_last_sheet() {
        ...
        let problem = parse_problem("10x10:0:10x6,10x4,3x3").expect("parse error");
